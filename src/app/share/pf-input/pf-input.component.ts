...
@Component({
  ...
  styleUrls: ["./pf-input.component.scss"],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: PfInputComponent,
      multi: true,
    },
  ],
})
  ...
  implements OnInit, ControlValueAccessor
{
  ...
  */
  ...
  public getDisplayValue() {
    const me = this;
    if (!me.pfUtil.isEmpty(me.displayValue)) {
      return me.displayValue;
    }
    return me.pfValue === null || me.pfValue === undefined || me.pfValue === ""
      ? me.pfPlaceHolder
      : me.pfValue;
  }
}
