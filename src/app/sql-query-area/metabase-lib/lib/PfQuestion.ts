//用此类来取代metabase的src\app\subsystem\computes\components\sql-query-area\metabase-lib\lib\Question.ts
...
// import * as Card_DEPRECATED from "../../model/card";
// //import * as Urls from "metabase/lib/urls";
// //import { syncTableColumnsToQuery } from "../../lib/dataset";
 ...
 */
export default class PfQuestion {
  /**
  ...
  constructor(
    card: CardObject,
    metadata: PfMetadataClass
    // metadata: Metadata, // parameterValues?: ParameterValues, // update?: ?QuestionUpdateFn,
  ) {
    this._card = card;
  ...
  setCard(card: CardObject): PfQuestion {
    const q = this.clone();
    q._card = card;
    return q;
  }
