...
export default class Aggregation extends MBQLClause {
  ...
  replace(aggregation?: AggregationObject | Aggregation): IStructuredQuery {
    if (aggregation != null) {
      ...
      return this._query.updateAggregation(this._index, this as any);
    }
  }
   ...
   */
  isStandard() {
    return AGGREGATION.isStandard(this as any);
  }
   ...
   */
  isMetric() {
    return AGGREGATION.isMetric(this as any);
  }
   ...
   */
  isCustom() {
    return AGGREGATION.isCustom(this as any);
  }
