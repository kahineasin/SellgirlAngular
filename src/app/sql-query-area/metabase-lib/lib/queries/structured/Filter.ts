...
import { generateTimeFilterValuesDescriptions } from "../../../../lib/query_time";
import {
  isStandard,
  isSegment,
  isCustom,
...
import { getFilterArgumentFormatOptions } from "../../../../lib/schema_metadata";
...
export default class Filter extends MBQLClause {
   ...
   */
  replace(filter?: Filter | FilterObject): StructuredQueryClass {
    if (filter != null) {
