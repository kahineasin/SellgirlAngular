...
import { OrderBy as OrderByObject } from "../../../../model/Query";
import StructuredQueryClass from "../../../../metabase-lib/lib/queries/StructuredQuery";
import Dimension from "../../../../metabase-lib/lib/Dimension";
import FieldClass from "../../../../metabase-lib/lib/metadata/Field";
export default class OrderBy extends MBQLClause {
   ...
   */
  replace(orderBy?: OrderBy | OrderByObject): StructuredQueryClass {
    if (orderBy != null) {
