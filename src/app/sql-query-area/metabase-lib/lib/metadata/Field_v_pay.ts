...
//import { ConcreteField } from "../../../model/Query";
...
export default class Field extends Base {
  ...
  displayName({
    ...
    if (includePath) {
      ...
      displayName += formatField(this as any);
    }
    return displayName;
  }
  ...
  dimension() {
    if (Array.isArray(this.id)) {
      ...
      return Dimension.parseMBQL((this as any).id, this.metadata, this.query);
    } else {
      return Dimension.parseMBQL(
        ["field", this.id, null] as any,
        this.metadata,
        this.query as StructuredQueryClass
      );
    }
  }
  ...
  filterOperatorsLookup() {
    return createLookupByProperty(this.filterOperators(null), "name");
  }
  ...
  get filter_operators() {
    return this.filterOperators(null);
  }
