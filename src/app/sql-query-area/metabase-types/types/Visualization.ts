// import type { DatasetData, Column, Row, Value } from "../../model/Dataset";
// import type { Card, VisualizationSettings } from "./Card";
...
// export type OnChangeCardAndRun = (a: {
//   nextCard: Card;
//   previousCard?: Card;
// }) => void;
...
//   //   warnings?: string[],
//   // }) => void,
//   onRender: (a: { yAxisSplit?: number[][]; warnings?: string[] }) => void;
...
//   onUpdateVisualizationSettings: (a: { [key: string]: any }) => void;
