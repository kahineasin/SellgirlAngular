...
//import { STANDARD_FILTERS } from "../expressions";
import { STANDARD_FILTERS } from "../expressions/config";

import type { FilterClause, Filter, FilterOptions } from "../../model/Query";
...
export function isStandard(filter: FilterClause): boolean {
  return (
    ...
    (STANDARD_FILTERS.has(filter[0] as any) || filter[0] === null) &&
