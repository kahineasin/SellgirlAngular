...
import utc from 'dayjs/plugin/utc'; //benjamin tocheck
moment.extend(utc);

//import 'dayjs/plugin/utc.d';
...
//   "day-of-week": (value) => moment.parseZone(value, "ddd").startOf("day"),//benjamin todo
// };
...
export function parseTime(value) {
  if (moment.isDayjs(value)) {
    ...
    //   "HH:mm",
    // ]);
    return moment(value).format('HH:mm:SS.sssZZ'); //这样替换moment不知道有无问题--benjamin todo
  } else {
