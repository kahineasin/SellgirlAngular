//export * from "./config";//开源版本重复引用了--benjamin 20211230
...
export function formatMetricName(metric, options?: any) {
...
export function formatSegmentName(segment, options?: any) {
...
export function formatDimensionName(dimension, options?: any) {
